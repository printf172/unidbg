...
public class demo1 extends AbstractJni implements IOResolver {
    ...
    demo1(){
        ...
        DalvikModule dm = vm.loadLibrary(new File("/Users/jiewang/IdeaProjects/printf172/unidbg/unidbg-android/src/test/resources/lession8/libnative-lib.so"), true);
        module = dm.getModule();
        ...
        switch (signature) {
            ...
            case "android/content/SharedPreferences->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;": {
                ...
                if(((StringObject) dvmObject.getValue()).getValue().equals("one")){
                    // 如果键是name
                    if (vaList.getObjectArg(0).getValue().equals("name")) {
