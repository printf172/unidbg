...
public class NBridge extends AbstractJni implements IOResolver {
    ...
    NBridge(){
        ...
        vm = emulator.createDalvikVM(new File("/Users/jiewang/IdeaProjects/printf172/unidbg/unidbg-android/src/test/resources/lession10/mt.apk")); // 创建Android虚拟机

        emulator.getSyscallHandler().addIOResolver(this); // 添加系统调用解析器
        vm.setVerbose(true); // 设置是否打印Jni调用细节
        DalvikModule dm = vm.loadLibrary(new File("/Users/jiewang/IdeaProjects/printf172/unidbg/unidbg-android/src/test/resources/lession10/libmtguard.so"), true);
    ...
    public int getStaticIntField(BaseVM vm, DvmClass dvmClass, String signature) {
        switch (signature) {
            case "android/content/pm/PackageManager->GET_SIGNATURES:I":return 64;
        }
