...
public class LibBili1 {
    ...
    LibBili1(){
        ...
        vm = emulator.createDalvikVM(new File("/Users/jiewang/IdeaProjects/printf172/unidbg/unidbg-android/src/test/resources/lession6/lession6/bilibili.apk")); // 创建Android虚拟机
        vm.setDvmClassFactory(new ProxyClassFactory());
        vm.setVerbose(true); // 设置是否打印Jni调用细节
        DalvikModule dm = vm.loadLibrary(new File("/Users/jiewang/IdeaProjects/printf172/unidbg/unidbg-android/src/test/resources/lession6/lession6/libbili.so"), true);
        module = dm.getModule(); //
