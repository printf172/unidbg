...
public class zuiyou extends AbstractJni{
    ...
    zuiyou() {
        ...
        vm = emulator.createDalvikVM(new File("/Users/jiewang/IdeaProjects/printf172/unidbg/unidbg-android/src/test/resources/使用unidbg跑通最右sign/unidbg/right/right573.apk")); // 创建Android虚拟机
        DalvikModule dm = vm.loadLibrary(new File("/Users/jiewang/IdeaProjects/printf172/unidbg/unidbg-android/src/test/resources/使用unidbg跑通最右sign/unidbg/right/libnet_crypto.so"), true); // 加载so到虚拟内存,参数二设为false(即不执行init相关函数)
